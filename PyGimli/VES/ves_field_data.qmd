...
```{python}
data = pd.read_table("PyGimli/VES/curso_geofisica/datos/SEV1.TXT")
print(data.head())
vescode = "SEV-1" # Código del sondeo, nombre a usar en archivos de salida

# ab2, mn, roa = np.genfromtxt("PyGimli/VES/curso_geofisica/datos/SEV1.TXT", 
#                              skip_header=1,
#                              unpack=True)
...
# plt.savefig("PyGimli/VES/" + vescode + ".png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("PyGimli/VES/" + vescode + "-chi2-marquardt-.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("PyGimli/VES/" + vescode + "-chi2-vesmanager-.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("PyGimli/VES/" + vescode + "-fit-modelos-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("PyGimli/VES/" + vescode + "-modelos-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
with open("PyGimli/VES/" + vescode + "-modelo-" + str(ncapas) + "capas.txt", "w") as f:
...
# plt.savefig("PyGimli/VES/" + vescode + "-fit-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("PyGimli/VES/" + vescode + "-correl-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("PyGimli/VES/" + vescode + "-fit-errorbars-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
