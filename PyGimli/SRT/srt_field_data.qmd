...
data = tt.load("GeoPy/PyGimli/SRT/prueba_vs.sgt")
data.sortSensorsX()
print(data)
...
# plt.savefig('GeoPy/PyGimli/SRT/tomo-picks-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('GeoPy/PyGimli/SRT/srt-chi2-iter-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
with open("GeoPy/PyGimli/SRT/velocidades-" + tomocode + ".txt", "w") as f:
    f.writelines(vlist)
```
...
# plt.savefig('GeoPy/PyGimli/SRT/tomo-fit-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('GeoPy/PyGimli/SRT/refra-model-fit-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('GeoPy/PyGimli/SRT/tomo-refra-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('GeoPy/PyGimli/SRT/tomo-refra-contour-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('GeoPy/PyGimli/SRT/tomo-refra-' + tomocode + '-1D-' + f"{x[0]:.0f} m" + ".png", dpi=300, bbox_inches='tight')
```

## Salvar resultados

```{python}
mgr_refra.saveResult('GeoPy/PyGimli/SRT/tomo-refra-' + tomocode + '/')
```
