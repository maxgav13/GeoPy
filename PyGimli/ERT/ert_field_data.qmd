...
```{python}
data = ert.load('PyGimli/ERT/Wenner_1_2.dat', verbose=True)
print(data)
...
# plt.savefig('PyGimli/ERT/ert-' + tomocode + '-chi2-iter.png', dpi=300, bbox_inches='tight')
```
...
with open("PyGimli/ERT/resistividades-" + tomocode + "-.txt", "w") as f:
    f.writelines(rlist)
```
...
# plt.savefig('PyGimli/ERT/tomo-res-fit.png', dpi=300, bbox_inches='tight')
```

```{python}
mgr_ert.showFit()

# plt.savefig('PyGimli/ERT/tomo-fit.png', dpi=300, bbox_inches='tight')
```

```{python}
mgr_ert.showMisfit()

# plt.savefig('PyGimli/ERT/tomo-misfit.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('PyGimli/ERT/tomo-res-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('PyGimli/ERT/tomo-mesh-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('PyGimli/ERT/res-model-fit-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('PyGimli/ERT/tomo-res-contour-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('PyGimli/ERT/tomo-cond-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('PyGimli/ERT/tomo-res-' + tomocode + '-1D-' + f"{x[0]:.0f} m" + ".png", dpi=300, bbox_inches='tight')
```
...
```{python}
mgr_ert.saveResult('PyGimli/ERT/tomo-res-' + tomocode + '/')
```

Salva los datos en un formato unificado

```{python}
data.save('PyGimli/ERT/Wenner_py.dat')
```