...
data = tt.load("SRT/prueba_vs.sgt")
data.sortSensorsX()
print(data)
...
# plt.savefig('SRT/tomo-picks-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('SRT/srt-chi2-iter-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('SRT/tomo-fit-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('SRT/refra-model-fit-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('SRT/tomo-refra-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('SRT/tomo-refra-contour-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('SRT/tomo-refra-' + tomocode + '-1D-' + f"{x[0]:.0f} m" + ".png", dpi=300, bbox_inches='tight')
```
