...
```{python}
data = pd.read_table("VES/curso_geofisica/datos/SEV1.TXT")
print(data.head())
...
# plt.savefig("VES/" + vescode + ".png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("VES/" + vescode + "-chi2-marquardt-.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("VES/" + vescode + "-chi2-vesmanager-.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("VES/" + vescode + "-fit-modelos-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("VES/" + vescode + "-modelos-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("VES/" + vescode + "-fit-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("VES/" + vescode + "-correl-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
...
# plt.savefig("VES/" + vescode + "-fit-errorbars-" + str(ncapas) + "capas.png", dpi=300, bbox_inches='tight')
```
