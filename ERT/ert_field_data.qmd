...
```{python}
data = ert.load('ERT/Wenner_1_2.dat', verbose=True)
print(data)
...
```{python}
topo = np.loadtxt('ERT/DD_topo.txt', skiprows=1)
```
...
# plt.savefig('ERT/ert-' + tomocode + '-chi2-iter.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('ERT/tomo-res-fit.png', dpi=300, bbox_inches='tight')
```

```{python}
mgr_ert.showFit()

# plt.savefig('ERT/tomo-fit.png', dpi=300, bbox_inches='tight')
```

```{python}
mgr_ert.showMisfit()

# plt.savefig('ERT/tomo-misfit.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('ERT/tomo-res-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('ERT/tomo-mesh-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('ERT/res-model-fit-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('ERT/tomo-res-contour-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('ERT/tomo-cond-' + tomocode + '-.png', dpi=300, bbox_inches='tight')
```
...
# plt.savefig('ERT/tomo-res-' + tomocode + '-1D-' + f"{x[0]:.0f} m" + ".png", dpi=300, bbox_inches='tight')
```
